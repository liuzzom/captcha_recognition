...
def main():
    ...
    # Chain A
    a_c1 = layers.Conv2D(20, (5,5), strides=(2,2),padding='same', activation='relu')(inputs)
    a_mp1 = layers.MaxPooling2D()(a_c1)
    a_c2 = layers.Conv2D(32, (5,5), strides=(2,2),padding='same', activation='relu')(a_mp1)
    a_avg2 = layers.AveragePooling2D()(a_c2)
    a_c3 = layers.Conv2D(50, (5,5), strides=(2,2),padding='same',  activation='relu')(a_avg2)
    ...
    #Chain A
    a_fc1 = layers.Dense(512, activation='relu')(a_fl)
    a_fc2 = layers.Dense(10,activation='softmax')(a_fc1)
